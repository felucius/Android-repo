...
/**
 * A helper class you can use to get access to a list of smooth criminals.
 */
public class CriminalProvider
{
     ...
     * @paramthe index of the criminal in the list
     * @return the criminal
     */
    public static Criminal GetCriminal(int index) {
    ...
    private void fillCriminalList()
    {
        ...
        int[] drawableIds = new int[] { R.mipmap.maxime, R.mipmap.johncena,
                R.mipmap.warriorblood, R.mipmap.drunkenpitcher, R.mipmap.suspect };
